  ...
  return (
    <React.Fragment>
      <Toolbar
        ...
        {numSelected > 0 ? (
          ...
          <Typography className={classes.title} variant="h3" id="tableTitle" component="div">
            Listado de Secciones del Sistema{'  '}
          </Typography>
        )}
      ...
      <ConfirmDialog
        ...
        title={`Confirma Eliminar Permiso`}
...
export default React.memo(SectionTableToolbar);
