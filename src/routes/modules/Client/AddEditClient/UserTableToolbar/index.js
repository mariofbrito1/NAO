  ...
  const handleConfirmDelete = () => {
    ...
    dispatch(
      deleteBulkUsers(selected, () => {
        setSelected([]);
        console.log('deleted ok', selected);
      }),
    );
  };
  ...
  return (
    <React.Fragment>
      <Toolbar
        ...
        {numSelected > 0 ? (
          ...
          <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
            1000 Puntos{' '}
            <Button className="btn btn-btn" color="primary" onClick={() => onUserNew()}>
              Puntos
            </Button>
          </Typography>
        )}
      ...
      <ConfirmDialog
        ...
        content={'Esta seguro de que desea eliminar los Clientes seleccionados?'}
