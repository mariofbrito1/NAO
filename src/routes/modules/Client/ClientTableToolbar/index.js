...
const filterOptionsList = [{ label: 'Modo Mobile', value: 'mobile' }];
...
const UserTableToolbar = ({
  ...
  const onFilterOptionClick = option => {
    setFilterOptions(prevState => {
      setMyFilterMobile(!filterOptions.includes(option.value));
    ...
    <React.Fragment>
      <Toolbar
        ...
        <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
          ...
          <Button color="primary" onClick={() => onNewClient()}>
            Nuevo Cliente
          </Button>
        </Typography>
      ...
      <ConfirmDialog
        ...
        title={`Confirma Eliminar Clientes`}
        content={'Esta seguro de que quiere eliminar los Clientes selecionados?'}
