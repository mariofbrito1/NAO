    ...
    return (
      <>
        <Tooltip title="Add to cart">
          <IconButton aria-label="Add to cart" onClick={onProviderAddClick}>
            <AddShoppingCartIcon />
          </IconButton>
        </Tooltip>
        <Snackbar
      ...
      <Toolbar
        className={clsx(classes.root, {
          ...
          <Typography className={classes.title} variant="h3" id="tableTitle" component="div" style={{marginTop: '20px' }}>
            ...
            <Chip style={{margin: '20px' }} icon={<NextWeek />} label={(rowCount!==1) ? rowCount+ ' Proveedores' : rowCount+ ' Proveedor'} />
            {seccionesUser[0].id_rol === ID_ROL_ADM && (<>
               
                <Button style={{ marginLeft: '25px', marginRight: '25px' }} color="primary" onClick={() => onNewProvider()}>
                  Nuevo Proveedor
                </Button> 
...
ProviderTableToolbar.propTypes = {
...
export default React.memo(ProviderTableToolbar);
