...
const Producto = ({ stateProd, setStateProd, resetFlag }) => {
  ...
  useEffect(() => {
    ...
    if (product.idtipomaterial) {
      ...
      setLevel({ ...level, levelOne: false, levelTwo: false, levelThree: false, levelFour: false, levelFive: false });
    }
    ...
    <>
      <Grid container spacing={2}>
        <Grid item xs={12} sm={6} md={6}>
          <Box px={10} mb={3}>
            {' '}
            {/* Esto agrega un margen inferior de 24px */}
