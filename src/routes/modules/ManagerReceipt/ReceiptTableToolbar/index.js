    ...
    return (
      <>
        <Tooltip title="Add to cart">
          <IconButton aria-label="Add to cart" onClick={onReceiptAddClick}>
            <AddShoppingCartIcon />
          </IconButton>
        </Tooltip>
        <Snackbar
      ...
      <Toolbar
        className={clsx(classes.root, {
          ...
          <Typography className={classes.title} variant="h3" id="tableTitle" component="div" style={{marginTop: '20px' }}>
            ...
            <Chip style={{margin: '20px' }} icon={<NextWeek />} label={(rowCount!==1) ? rowCount+ ' Recibos' : rowCount+ ' Rebibo'} />
            {seccionesUser[0].id_rol === ID_ROL_ADM && (<>
               
                <Button style={{ marginLeft: '25px', marginRight: '25px' }} color="primary" onClick={() => onNewReceipt()}>
                  Agregar recibo
                </Button> 
...
export default React.memo(ReceiptTableToolbar);
