  ...
  return (
    <React.Fragment>
      <Toolbar
        ...
        {numSelected > 0 ? (
          ...
          <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
            Usuarios{' '}
            <Button color="primary" onClick={() => onUserNew()}>
              Nuevo Usuario
            </Button>
          </Typography>
        )}
      ...
      <ConfirmDialog
        ...
        title={`Confirma Eliminar estas Transacciones`}
        content={'Esta seguro de que desea eliminar las trnasacciones seleccionadas?'}
