...
const UsersModule = ({ history }) => {
  ...
  useEffect(() => {
    dispatch(
      addNewUser(filterOptions, debouncedSearchTerm, () => {
        //console.log('GET onUserAdd');
  ...
  return (
    <div className={classes.root}>
                ...
                <TableRow style={{ height: 53 * 6 }}>
                  <TableCell colSpan={7} rowSpan={10}>
                    {isFilterApplied ? (
                      ...
                      <NoRecordFound>{usersFetched ? 'There are no records found.' : 'Loading profiles...'}</NoRecordFound>
                    )}
                  </TableCell>
                </TableRow>
              )}
      ...
      <ConfirmDialog
        ...
        title={`Confirma Eliminar a ${selectedUser.name}`}
